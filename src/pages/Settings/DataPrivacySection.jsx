  ...
  return (
    <div className="mt-8 mb-16 lg:mb-12 border border-red-900/30 rounded-xl p-6 bg-[#18111A] flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
        <button className={`${themeClasses.cardBg} hover:${themeClasses.bgSecondary} border ${themeClasses.cardBorder} ${themeClasses.textSecondary} text-xs font-bold py-2.5 px-6 rounded-lg transition-colors flex items-center justify-center gap-2`}>
